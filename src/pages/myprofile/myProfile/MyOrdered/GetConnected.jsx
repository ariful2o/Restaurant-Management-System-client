    ...
    <div>
      <div className="text-center space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-16 max-w-7xl mx-auto my-20">
          <img src="https://i.ibb.co/mzQXsmS/Group-4.png" alt="" />
          <img src="https://i.ibb.co/nM0rbyS/Group-3.png" alt="" />
          <img src="https://i.ibb.co/x3JXPwx/Group-2.png" alt="" />
          <img src="https://i.ibb.co/j5VLjYV/Group-1.png" alt="" />
          <img src="https://i.ibb.co/k2nMr2d/Group-27.png" alt="" />
          <img src="https://i.ibb.co/jytMsSd/Group.png" alt="" />
        </div>
